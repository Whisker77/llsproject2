...
class RedisUtils:
    def __init__(self, host=settings.REDIS_HOST, port=settings.REDIS_PORT, db=0, password=''):
        """
            初始化Redis连接池
        :param host: 主机名
        :param port: 端口
    ...
    def set_params(self, key, value):
        return self.rdb.set(name=key, value=value)

    # def set(self, name, value):
    #     return self.rdb.set(name=name,value=value)